...
import TicketReply from '@/Pages/Users/Buyer/Support/support-reply.vue';
...
const props = defineProps({
    auth:Object,users:Object,tickets:Object,replies:Object,wallet:Number,
    notifications:Object,companies:Object,descriptions:Object,alert: Object,
    cart:Object
});
...
const submitTime = ()=>{
    Inertia.visit(route('support.show',form.parent_id),{ only: [errors.value,hasErrors.value,props.alert] })
}
const submit = (id) => {
    form.destination = id
    if(form.text){
                                ...
                                <div class="col-sm-12 mt-3">
                                        ...
                                        <div class="mb-4 me-5">
                                            <div class="d-flex">
                                                ...
                                                <a v-if="props.tickets.user.id !== props.users.id && props.tickets.status !== 3" :href="'#CollapseExample'+props.tickets.id" class="reply" data-bs-toggle="collapse" aria-expanded="false" :aria-controls="'CollapseExample'+props.tickets.id">پاسخ</a>
                                            </div>
                                        </div>
                                    ...
                                    <TicketReply  :tickets="props.tickets" :replies="props.replies" :users="props.users" :auth="props.auth" :alert="props.alert" />
                                </div>
                        </div>
                </div>
            </form>
