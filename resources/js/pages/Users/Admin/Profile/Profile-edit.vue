...
const submitTime = ()=>{
    Inertia.visit(route('profileAdmin.edit',form.id),{ only: [errors.value,hasErrors.value,props.alert] })
}
                        ...
                        <div class="row gx-5">
                            ...
                            <div class="col-lg-9">
                                <div class="col-lg-2 me-auto">
                                    ...
                                    <p v-if="props.user.profile.status == 0">ثبت شده</p>
                                    <p v-else-if="props.user.profile.status == 1"> درانتظار</p>
                                    <p v-else-if="props.user.profile.status == 2">مسدود شده</p>
                                    <p v-else-if="props.user.profile.status == 3">رد شده</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <aside class="col-lg-4">
                                                <figure class="text-lg-center">
                                                    ...
                                                    <img  v-if="props.user.profile.image && props.user.profile.image.url" class="img-lg mb-3 img-avatar" :src="$page.props.ziggy.url+'/storage/'+props.user.profile.image.url" :alt="props.user.show_name" />
