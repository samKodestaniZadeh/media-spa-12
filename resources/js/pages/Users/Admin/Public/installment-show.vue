...
const props = defineProps({
    ...
    notifications:Object,menus:Object,companies:Object,descriptions:Object,alert:Object,subs:Object,wallet:Number,
    cart:Object
});
...
const submitTime = ()=>{
    Inertia.visit(route('installment.show',props.menus.id),{ only: [errors.value,hasErrors.value,props.alert] })
}
const submit = () =>{
    form.subs = null
    if( form.name == null)
    ...
    {
        form.put(route('installment.update',form.id),{
            onFinish:() => submitTime()
        })
    }
};
...
const submitDel = (installmentable_type,installmentable_id) =>{
        form.type = installmentable_type,
        form.del = installmentable_id
                                ...
                                <div class="row  gx-2">
                                    <div class="col-lg-6">
                                        <div class="mt-4">
                                            ...
                                            <div class="row gx-2">
                                                <input v-model.lazy="form.count" placeholder="اینجا تایپ کنید" type="text" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row  gx-2">
                                    <div class="col-lg-6">
                                        <div class="mt-4">
                                            ...
                                            <input v-model.lazy="form.installmentable_type" placeholder="اینجا تایپ کنید" type="text" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mt-4 ">
                                            ...
                                            <div class="d-flex">
                                                <input v-model.lazy="form.installmentable_id" placeholder="اینجا تایپ کنید" type="text" class="form-control" />
                                ...
                                <div class="row  gx-2" v-for="menu, index in props.subs.data" :key="index">
                                    <div class="col-lg-6">
                                        <div class="mt-4">
                                            ...
                                            <input v-model.lazy="menu.installmentable_type" placeholder="اینجا تایپ کنید" type="text" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mt-4">
                                            ...
                                            <div class="d-flex">
                                                <input v-model.lazy="menu.installmentable_id" placeholder="اینجا تایپ کنید" type="text" class="form-control" />
                                                <button @click.prevent="submitDel(menu.installmentable_type,menu.installmentable_id)" :class="{ 'opacity-25': form.processing }" :disabled="form.processing"
