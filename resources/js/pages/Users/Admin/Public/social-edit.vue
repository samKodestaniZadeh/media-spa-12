...
const props = defineProps({
    ...
    cartTotal:Object,companies:Object,descriptions:Object,alert:Object,socials:Object,menus: Object,
    wallet:Number,cart:Object
});

const form =  useForm({
    id:props.socials.id,
    title:props.socials.title,
    tag:props.socials.tag,
    status:props.socials.status,
});
...
const submitTime = ()=>{
    Inertia.visit(route('socialAdmin.edit',[form.id]),{ only: [errors.value,hasErrors.value,props.alert] })
}
const submit = () =>{

    if(form.status == null || form.tag == null)
    {
        let text
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                    <div class="mt-1">
                                        ...
                                        <!-- <input  readonly v-model.lazy="form.title" type="text" placeholder="اینجا تایپ کنید" class="form-control" id="product_name" /> -->
