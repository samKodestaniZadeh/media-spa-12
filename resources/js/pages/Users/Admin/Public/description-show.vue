...
const props = defineProps({
    users:Object,cartPrice:Object,cartCount:Number,cartDiscount:Number,cartCoupon:String|Number,cartTotal:Number,
    notifications:Object,descriptions:Object,companies:Object,description:Object,alert:Object,subs:Object,
...
if (hasErrors.value == true) {
    ...
    didOpen: (toast) => {
        ...
        title: [errors.value.subject ? errors.value.subject +'<br>' :'' ,
...
const submitTime = ()=>{
    Inertia.visit(route('description.show',props.description.id),{ only: [errors.value,hasErrors.value,props.alert] })
}


const submit = () =>{
    if(form.subject == null && form.text == null)
    {
        let text
    ...
    {
        form.post(route('description.store',form.id),{
            onFinish:() => submitTime()
        })
    }
...
const submitSub = () =>{
    ...
    {
        form.put(route('description.update',form.id),{
            onFinish:() => submitTime()
        })
    }
};

const submitDel = (descriptionable_type,descriptionable_id) =>{
        form.type = descriptionable_type,
        form.del = descriptionable_id
                                ...
                                <div class="row  gx-2">
                                    <div class="col-lg-12">
                                        <div class="mt-4">
                                            ...
                                            <!-- <input v-model.lazy.trim="form.subject" placeholder="اینجا تایپ کنید" type="text" class="form-control" /> -->
                                            <Editor api-key="0jyg8kag8oi7nb67i513jba26ynnauhhfpwlqckgygf32ly5" :init="{menubar: false }" v-model="form.subject" />
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            <div class="col-lg-12">
                                <div class="row  gx-2" v-for="menu, index in form.subs" :key="index">

                                    <div class="col-lg-6">
                                        <div class="mt-4">
                                            <label class="form-label">نام مدل</label>
                                            <input v-model.lazy="menu.descriptionable_type" placeholder="اینجا تایپ کنید" type="text" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mt-4 ">
                                            ...
                                            <div class="d-flex">
                                                <input v-model.lazy="menu.descriptionable_id" placeholder="اینجا تایپ کنید" type="text" class="form-control" />

                                                <button @click.prevent="submitDel(menu.descriptionable_type,menu.descriptionable_id)" :class="{ 'opacity-25': form.processing }" :disabled="form.processing"
                                ...
                                <div class="row  gx-2">
                                    <div class="col-lg-6">
                                        <div class="mt-4">
                                            ...
                                            <input v-model.lazy="form.descriptionable_type" placeholder="اینجا تایپ کنید" type="text" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mt-4 ">
                                            ...
                                            <div class="d-flex">
                                                <input v-model.lazy="form.descriptionable_id" placeholder="اینجا تایپ کنید" type="text" class="form-control" />
