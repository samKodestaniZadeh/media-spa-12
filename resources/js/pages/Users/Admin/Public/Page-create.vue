...
const submitTime = ()=>{
    Inertia.visit(route('page.create'),{ only: [errors.value,hasErrors.value,props.alert] })
}

const submit = () =>{

    if(form.route == null || form.title == null || form.text == null)
    {
        let text
                        ...
                        <div class="card-body">
                            <div class="col-lg-12">
                                <div class="row  gx-2">
                                    <div class="col-lg-12">
                                        <div class="mt-4">
                                            <label class="form-label">نام روت<span class="text-danger">*</span></label>
                                            <div class="row gx-2">
                                                <input v-model.lazy.trim="form.route" placeholder="اینجا تایپ کنید" type="text" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
