...
const form =  useForm({installment:null,count:null});
...
const submitTime = ()=>{
    Inertia.visit(route('installment.create'),{ only: [errors.value,hasErrors.value,props.alert] })
}
const submit = () =>{
    ...
    {
        form.post(route('installment.store'),{
            onFinish:() => submitTime()
        })
    }
};
                                ...
                                <div class="row  gx-2">
                                    <div class="col-lg-12">
                                        <div class="mt-4">
                                            ...
                                            <div class="row gx-2">
                                                <input v-model.lazy.trim="form.count" placeholder="اینجا تایپ کنید" type="text" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
