...
const submitTime = () => {
    Inertia.visit(route('route.show', props.menus.id), { only: [errors.value, hasErrors.value, props.alert] });
};
                                    ...
                                    <div class="mt-5" v-if="props.subs.total > 9">
                                        <nav aria-label="Page navigation example">
                                            <ul class="pagination justify-content-start">
                                                <li
                                                    :class="['page-item', link.url == null ? 'disable' : '', link.active ? 'active' : '']"
                                                    v-for="link in props.subs.links"
                                                    :key="link.id"
                                                >
