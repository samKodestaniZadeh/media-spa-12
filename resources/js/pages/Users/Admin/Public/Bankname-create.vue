...
const props = defineProps({users:Object,cartPrice:Number,cartCount:Number,
cartDiscount:Number,cartCoupon:Number,cartTotal:Number,notifications:Object,
            ...
            <div class="row">
                <div class="col-12">
                    <div class="content-header">
                        ...
                        <button @click.prevent="submit" :class="{ 'opacity-25': form.processing }" :disabled="form.processing" class="btn btn-md rounded font-sm hover-up">ایجاد</button>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="card mt-4">
