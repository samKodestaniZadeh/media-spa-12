...
const props = defineProps({
    users:Object,description:Object,ids:Object,statuses:Object,subjects:Object,cartNumber:Number,wallet:Number,
    cartPrice:Number,cartCount:Number,cartDiscount:Number,cartCoupon:Number,cartTotal:Number,notifications:Object,companies:Object,
            ...
            <section class="content-main">
                <div class="row content-header">
                    <div class="d-flex col-sm-12">
                        ...
                        <td class="me-auto">
                            <Link :href="route('description.create')" class="btn btn-primary btn-sm rounded font-sm">ایجاد</Link>
                        </td>
                    </div>
                    <div class="col-sm-12">
                        ...
                        <Aside class="col-lg-3 border-end" />
                            <div class="col-lg-9">
                                <section class="content-body p-xl-4">
                                    <div class="table-responsive" v-if="props.description.total > 0">
                                        <table v-if="props.description.total > 0" class="table table-hover">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody >
                                                <tr v-for="menu in props.description.data" :key="menu.id">
                                                    <td>{{(menu.id).toLocaleString("fa-IR")}}</td>
                                                    <td>{{menu.user.user_name}}</td>
                                                    <td v-html="menu.subject"></td>
                                                    <td>
                                        ...
                                        <div class="mt-5" v-if="props.description.total > 9 ">
                                            <nav aria-label="Page navigation example">
                                                <ul class="pagination justify-content-start">
                                                    <li :class="['page-item',link.url == null ? 'disable' :'',link.active ? 'active' : '']"
                                                    v-for="link in props.description.links" :key="link.id" >
