...
const props = defineProps({
    orders: Object, users: Object, menus: Object,wallet:Number, notifications: Object, companies: Object,
...
const form = useForm({
    ...
    image: null,prerequisites:[] ,prerequisite_version:[] ,additional_facilities:[],
    test:[] , sub_test:[],
});
...
const sub_prerequisites = ()=>{
    ...
    if (prerequisite_version.value.length > 0 ) {
        ...
        // console.log(prerequisite_version.value)
    }
                                        ...
                                        <div class="col-lg-6" v-if="form.prerequisites" v-for="prerequisite,index in form.prerequisites" :key="index" >
                                            ...
                                            <select v-model.lazy="form.prerequisite_version[prerequisite.id]" class="form-select">
                                                <template v-for="child,index in prerequisite_version" :key="index">
                                                    <option v-if="prerequisite.id == child.parent_id"  :value="child" >{{ child.name }}</option>
                                                </template>
                                            </select>
                                        </div>
                                    </div>
...
<style scoped>
@import url(/node_modules/vue-multiselect/dist/vue-multiselect.css);
.logo {
  display: block;
  margin: 0 auto 2rem;
}
