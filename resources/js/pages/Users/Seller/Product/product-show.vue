...
const props = defineProps({
    orders:Object,users:Object,wallet:Number,notifications:Object,ids:{type: [Object, String],default: () => ({})},times:{type: [Object, String],default: () => ({})},
    statuses:{type: [Object, String],default: () => ({})},prices:Object,companies:Object,descriptions:Object,dark: String,asidemini:String,
    path:String
});
...
<Header :cartPrice="props.cartPrice"  :wallet="props.wallet" :alert="props.alert" :users="props.users"
                            ...
                            <table v-if="props.orders.total > 0 " class="table table-responsive">
                                ...
                                <tbody >
                                    <tr v-for="(order,index) in props.orders.data" :key="index">
                                        ...
                                        <td>{{(order.tax).toLocaleString("fa-IR")}}</td>
                                        <td>{{(order.col).toLocaleString("fa-IR")}}</td>
                                        <td>
