...
import ExtensionOption from '@/Components/ExtensionOptionsTarahi.vue';
...
const props = defineProps({
    tarahi: Object, auth: Object, cart: Object, time: String, count: Number, menus: Object,
    alert: Object, flash: String, tarahi_count: Number, tarahi_order: Number, coupon_count: Number,
    companies: Object, reqdesigners: Object,comments:Object,replies:Object,
});
...
const favorite = ref();
props.tarahi.favorite.forEach(element => {
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-md-9 col-lg-7">
                <div class="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                    <h1 class="text-white mb-0">پروژه ها</h1>
                    <div class="custom-breadcrumb">
                        <ol class="breadcrumb d-inline-block bg-transparent list-inline py-0">
                            ...
                            <li class="list-inline-item breadcrumb-item active">سفارشات</li>
                            <li class="list-inline-item breadcrumb-item active">پروژه ها</li>
                        </ol>
                    </div>
                </div>
            </div>
...
<div class="container-fluid mb-4">
    <ExtensionOption :tarahi="props.tarahi" :tarahi_count="props.tarahi_count" :tarahi_order="props.tarahi_order"
            :cart="props.cart" :time="props.time" :count="props.count" :alert="props.alert" :flash="props.flash"
            :auth="props.auth" :companies="props.companies" :menus="props.menus" />
        ...
        <div class="card text-right">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    <li class="nav-item">
                        <Link class="nav-link color-succss" :href="route('website_design.show',props.tarahi.slug)">توضیحات</Link>
                    </li>
                    <li class="nav-item">
                        <Link class="nav-link active" href="#">پرسش و پاسخ</Link>
                    </li>
                    <!-- <li class="nav-item">
                        <Link class="nav-link color-succss" :href="route('guest_support.show',props.tarahi.name)">پشتیبانی</Link>
                    </li> -->
                </ul>
            </div>
                 ...
                 <div class="comments-area mb-5">
                    ...
                    <div class="comment-list">
                        <div class="comment" v-for="(comment,index) in props.comments" :key="index">
                                ...
                                <div class="submenu text-a-l collapse " :id="'multiCollapseExample'+comment.id">
                                        <form class="comment-form row " >
                                            ...
                                            <div class="form-submit col-md-12">
                                                <button @click.prevent="submitReply(comment.id)" class="btn btn-sm btn-primary mt-4" type="submit" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                            ...
                            <CommentReply :comments="props.replies" :comment_id ="comment.id" :files="props.files" :tarahi="props.tarahi" />
                        </div>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex bd-highlight">
                    ...
                    <div class="ml-auto bd-highlight">
                        <Link class="color-succss" :href="route('profile.show',[props.tarahi.user.id])">{{props.tarahi.user.user_name}}</Link>
                    </div>
                </div>
                <div class="d-flex bd-highlight">
                    <div class="bd-highlight">
                        <h5 class="card-title">تعداد پروژه ها</h5>
                    </div>
                    <div class="ml-auto bd-highlight">
                        <p class="card-text" v-if="props.count">{{(props.count).toLocaleString("fa-IR")}}</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="card mt-3 mb-3">
            ...
            <div class="card-body">
                <div class="d-flex bd-highlight">
                    ...
                    <div class="ml-auto bd-highlight">
                        <p class="card-text">
                            {{ moment(props.tarahi.created_at).locale("fa", fa).format('jYYYY/jM/jD') }}
                        </p>
                    </div>
                </div>
            </div>
